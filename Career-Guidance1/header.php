			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="../../Career-Guidance/index.php">Career</a>
					</div>
					<!-- /Logo -->
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						<li><a href="../../Career-Guidance/index.php">Home</a></li>
                        <li class="dropdown">
							...
							<!-- <a href="http://127.0.0.1/php%20CAREERLY/login.php">Career Prediction</a>-->
								<a href="templates/hometest copy.html">Career Prediction</a>
						...
						<li><a href="../../Career-Guidance/contact.php">Contact Us</a></li>
						<li><a href="../../Career-Guidance/logout.php" >Log out</a></li>
						<!--<li>

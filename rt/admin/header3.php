<?php 
	...
	//session_start();
		...
		$sql = "SELECT * FROM admin WHERE email='".$counsel_check."'";
...
<title>
		<?php 
			...
			}elseif($page === "con_dashboard"){
				echo $full_name." | ".$details['business_name'];
			}elseif($page === "inbox"){
    ...
    <nav id="menu-1" class="mega-menu fa-change-black" data-color=""> 
        <section class="menu-list-items"> 
          <ul class="menu-logo">
			...
			<li class="profile-pic"> <a href="javascript:void(0)"> <img src="../../images/admin.jpg" alt="user-img" class="img-circle" width="36"><span class="hidden-sm"><?= $first_name;?> </span> </a></li>

			<li> <a href="index.php"> <i class="fa fa-home fa-indicator"></i>  <?= $home['page_title']; ?></a></li>
			<li class="no-bg login-btn-no-bg"> <a href="../../login.php" class="login-header-btn"> <i class="fa fa-sign-in"></i><span>Student</span></a></li>
			...
			<li class="no-bg login-btn-no-bg"> <a href="logout.php" class="login-header-btn"> <i class="fa fa-sign-in"></i><span>Logout</span></a></li>

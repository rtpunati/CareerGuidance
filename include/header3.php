    ...
    <nav id="menu-1" class="mega-menu fa-change-black" data-color=""> 
        <section class="menu-list-items"> 
          <ul class="menu-logo">
			...
			<li> <a href="#"> <i class="fa fa-home fa-indicator"></i>  <?= $home['page_title']; ?></a></li>
				...
				<li class="profile-pic"> <a href="javascript:void(0)"> <img src="images/admin.jpg" alt="user-img" class="img-circle" width="36"><span class="hidden-sm"><?= $full_name;?> </span><i class="fa fa-angle-down fa-indicator"></i> </a>

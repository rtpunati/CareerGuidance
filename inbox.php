                            ...
                            <div class="resume-list">
                                <div class="table-responsive">
                                    <table class="table table-striped">
										...
										$sql = main_query("SELECT * FROM inbox WHERE student_email='".$email."' order by id desc");
											...
											while($row_msg = $sql->fetch_assoc()){
												...
												echo "<tr>
														<th scope='row'>$i</th>
														<td><h5>$catty</h5></td>
														<td><a class='btn btn-primary' href='conversation.php?id=$id'> View Conversation </a></td>
														<td><h5>$time</h5></td>
													</tr>";
